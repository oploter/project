...
Bullet::Bullet(sf::String F, float X, float Y, float W, float H, int dir_, int id_){
    dx=0;dy=0;speed=0.05;dir=dir_;
    life = true;
    File = F;
    w = W; h = H;
    id = id_;
...
ClientBullet::ClientBullet(sf::String F, float X, float Y, float W, float H, int dir_, int id_) : Bullet(F, X, Y, W, H, dir_, id_){}
ServerBullet::ServerBullet(sf::String F, float X, float Y, float W, float H, int dir_, const std::string &name_, int id_) : Bullet(F, X, Y, W, H, dir_, id_){
    name = name_;
}
